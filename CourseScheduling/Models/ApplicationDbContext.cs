    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Course>().HasData(
                new Course { CourseId = 1, CourseCode = "CS101", CourseName = "Introduction to Computer Science", Credits = 3, Time = "Mon 10:00 AM - 12:00 PM", Professor = "Prof1" },
                new Course { CourseId = 2, CourseCode = "MATH201", CourseName = "Calculus II", Credits = 4, Time = "Tue 1:00 PM - 3:00 PM", Professor = "Prof2" },
                ...
                new Course { CourseId = 5, CourseCode = "MATH231", CourseName = "Discrete Math", Credits = 3, Time = "MWF 1:00 PM - 3:00 PM", Professor = "Prof4" },
                new Course { CourseId = 6, CourseCode = "PSY325", CourseName = "Developmental Psychology", Credits = 3, Time = "MTF 12:30 PM - 1:45 PM", Professor = "Prof5" },
                new Course { CourseId = 7, CourseCode = "SOC338", CourseName = "Health & Lifestyle", Credits = 3, Time = "MWF 2:15 PM - 3:30 PM", Professor = "Prof6" },
                ...
                new Course { CourseId = 9, CourseCode = "MGMT681", CourseName = "Strategic Management", Credits = 3, Time = "MFW 3:30 PM - 4:45 PM", Professor = "Prof8" },
                new Course { CourseId = 10, CourseCode = "NURS362", CourseName = "Clinical Care Lab", Credits = 1, Time = "F 1:00 PM - 4:00 PM", Professor = "Prof9" },
                new Course { CourseId = 11, CourseCode = "GEOG235", CourseName = "Meteorology", Credits = 3, Time = "MWF 2:15 PM - 3:30 PM", Professor = "Prof10" },
