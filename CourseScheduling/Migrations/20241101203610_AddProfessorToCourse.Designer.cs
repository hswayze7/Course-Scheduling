...
namespace CourseScheduling.Migrations
{
    ...
    [Migration("20241101203610_AddProfessorToCourse")]
    partial class AddProfessorToCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseScheduling.Models.Enrollment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EnrollmentId = 1,
                            CourseId = 1,
                            EnrollmentDate = new DateTime(2024, 11, 1, 15, 36, 9, 838, DateTimeKind.Local).AddTicks(3435),
                            StudentId = 1
                        });
                });
